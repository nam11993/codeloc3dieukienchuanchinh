...
Vietnamese Stock Scanner Web App - Simple VersionStock Scanner Web App - Streamlit Interface

Webapp đơn giản để quét cổ phiếu Việt Nam (không có chart)Web version của Telegram bot với 2 bộ lọc: MUA 1 và MUA SỊN
...
# Import từ app.py gốcfrom plotly.subplots import make_subplots

from app import (import streamlit.components.v1 as components

    fetch_all_symbols, fetch_symbol_bundle, apply_filters, apply_filters_sin,from scanner_core import fetch_all_symbols, scan_symbols, get_chart_data
